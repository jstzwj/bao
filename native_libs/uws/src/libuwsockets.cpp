// clang-format off
// Bao: 添加 nonnull_arg 定义 (Linux 下为空)
#ifndef __APPLE__
#ifndef nonnull_arg
#define nonnull_arg
#endif
...
// Bao: replaced clang attribute push with GCC-compatible always_inline
#define BAO_FORCE_INLINE __attribute__((always_inline)) inline
...
// Bao: removed clang attribute pop (not needed with GCC)
}
